...
def checkout(request):
    ...
    render the checkout form and process the checkout.
    """
...
def checkout_success(request, order_number):
    """
    A view to render a sucess page on successful customer checkouts.
    """
